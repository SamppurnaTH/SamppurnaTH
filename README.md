...
<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=500&size=20&duration=3500&pause=1200&color=A78BFA&center=true&vCenter=true&width=700&height=50&lines=Building+AI+that+solves+real+problems.;10+public+repos+%26+counting.;Learning+by+shipping+in+production." alt="Typing SVG"/>
...
&nbsp;
![Last Updated](https://img.shields.io/github/last-commit/SamppurnaTH/SamppurnaTH?label=readme+updated&style=flat-square&color=7c3aed)
...
[![FarmConnect](https://github-readme-stats.vercel.app/api/pin/?username=SamppurnaTH&repo=FarmConnect&theme=github_dark&hide_border=true&title_color=a78bfa&icon_color=a78bfa&text_color=e2e8f0&bg_color=0d1117)](https://github.com/SamppurnaTH/FarmConnect)
...
[![iris-knn-classification](https://github-readme-stats.vercel.app/api/pin/?username=SamppurnaTH&repo=iris-knn-classification&theme=github_dark&hide_border=true&title_color=a78bfa&icon_color=a78bfa&text_color=e2e8f0&bg_color=0d1117)](https://github.com/SamppurnaTH/iris-knn-classification)
...
|---|---|---|---|
| [mental-health-predictor](https://github.com/SamppurnaTH/mental-health-predictor) | Mental Health Predictor | XGBoost + NLP | Healthcare |
| [customer-segmentation-kmeans](https://github.com/SamppurnaTH/customer-segmentation-kmeans) | Customer Segmentation Kmeans | KMeans Clustering | Business |
| [breast-cancer-svm](https://github.com/SamppurnaTH/breast-cancer-svm) | Breast Cancer Svm | Logistic Regression / SVM | Healthcare |
| [iris-knn-classification](https://github.com/SamppurnaTH/iris-knn-classification) | Iris Knn Classification | K-Nearest Neighbors | Benchmark |
| [heart-disease-prediction](https://github.com/SamppurnaTH/heart-disease-prediction) | Heart Disease Prediction | Random Forest / SVM / LR | Healthcare |
| [breast-cancer-logistic-regression](https://github.com/SamppurnaTH/breast-cancer-logistic-regression) | Logistic Regression model for Breast Cancer Detection (AI &  | Logistic Regression / SVM | Healthcare |
| [house-price-regression](https://github.com/SamppurnaTH/house-price-regression) | House Price Regression | Linear / Polynomial Regression | Real Estate |
| [titanic-pre-processing](https://github.com/SamppurnaTH/titanic-pre-processing) | Titanic Pre Processing | Data Preprocessing Pipeline | Benchmark |
...
*Auto-generated by GitHub Actions · Last run: 2026-04-24 07:58 UTC*
